...
function MainContainer() {
  ...
  const run = () => {
    axios
      .get("http://54.227.205.92:8080/api/home", {
        headers: {
      ...
      .then((res) => {
        ...
        if (res.data[0] == "false") {
          ...
          console.log(res.data);
          axios
            .get("http://54.227.205.92:8080/api/refresh", {
              headers: {
                refreshTokenId: `${sessionStorage.getItem("refreshTokenId")}`,
              },
            })
  ...
  useEffect(() => {
    axios
      .get(
        "https://raw.githubusercontent.com/jobhunting-page/jobhunt/main/companyInfo/news.json",
        {}
      )
      .then((res) => {
        setCompany(() => {
  ...
  return (
    <div className="banner_box">
      ...
      <br />
      <div className="SearchResultForm">{items}</div>
    </div>
  );
